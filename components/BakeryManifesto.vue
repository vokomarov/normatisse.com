...
<template>
    <section
        id="manifesto"
        class="brand-band flex min-h-[24rem] items-center py-14 sm:min-h-[28rem] sm:py-16 lg:min-h-[32rem] lg:py-20"
    >
        ...
        <div class="brand-band__inner">
            <!-- Four bars in two flush pairs: white for the claim, blush for the
                 aside, deep green for the two notes. Each bar hugs its own text —
                 the columns are flex, so no width or `display` is set on the lines. -->
            <blockquote class="mx-auto flex max-w-4xl flex-col items-center gap-5 text-center sm:gap-6">
                <!-- The aside hangs off the claim's right end. `items-start` makes
                     the group as wide as the claim (the longer line), so `self-end`
                     plus the inset keeps the aside short of the claim's edge. -->
                <div class="flex flex-col items-start">
                    ...
                    <p class="brand-quote-line brand-reveal bg-gradient-to-br from-white via-white to-blush-50 text-2xl leading-tight font-bold text-watercourse-800 sm:text-[2.25rem] lg:text-[2.75rem]">
                        Несу своє хобі в маси 🧁
                    </p>

                    <p
                        class="brand-quote-line brand-reveal mr-4 self-end bg-gradient-to-br from-blush-600 to-blush-800 text-xl leading-tight font-semibold text-white sm:mr-8 sm:text-2xl lg:mr-10 lg:text-[1.75rem]"
                ...
                <div class="flex flex-col items-center">
                    <p
                        class="brand-quote-line brand-reveal bg-gradient-to-br from-watercourse-950/90 to-watercourse-900/80 text-base leading-relaxed text-[var(--brand-on-deep)] backdrop-blur-[2px] sm:text-lg lg:text-xl"
